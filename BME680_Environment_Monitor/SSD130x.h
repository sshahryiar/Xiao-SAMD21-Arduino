...
class OLED
{
  public:
    ...
    OLED();
    void begin(TwoWire &wirePort = Wire, uint8_t deviceAddress = SSD1306_I2C_ADDRESS);
    ...
    void Bitmap(int16_t xb, int16_t yb, int16_t xe, int16_t ye, const uint8_t *bmp_img);
